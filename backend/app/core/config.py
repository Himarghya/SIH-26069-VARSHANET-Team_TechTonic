...
class Settings(BaseSettings):
    ...
    # Ingestion & Sync Configuration (Configurable via .env)
    AUTO_SYNC_INTERVAL_SECONDS: int = int(os.getenv("AUTO_SYNC_INTERVAL_SECONDS", "300")) # 5 minutes default
    NEWS_RETENTION_HOURS: int = int(os.getenv("NEWS_RETENTION_HOURS", "6")) # 6 hours active window
