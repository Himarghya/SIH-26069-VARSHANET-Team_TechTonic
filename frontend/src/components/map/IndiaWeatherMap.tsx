...
export const IndiaWeatherMap: React.FC<IndiaWeatherMapProps> = ({
  ...
  return (
    <div className="relative w-full h-full min-h-[580px] rounded-2xl overflow-hidden border border-slate-800/80 shadow-2xl bg-slate-950 flex flex-col font-sans">
      ...
      <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-[400] bg-slate-900/95 backdrop-blur-md px-4 py-2 rounded-2xl border border-slate-800 shadow-2xl flex items-center gap-3">
        <button
      ...
      {/* Legend Badge */}
      <div className="absolute bottom-3 left-3 z-[400] bg-slate-900/95 backdrop-blur-md p-2 rounded-xl border border-slate-800 text-[9px] space-y-1 shadow-2xl hidden md:block">
